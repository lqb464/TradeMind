# Capability extraction audit — TradeMind
...
## Capability được xây thêm

TradeMind không dừng ở research dashboard. Các boundary sau đã được bổ sung trực tiếp cho trading domain:
