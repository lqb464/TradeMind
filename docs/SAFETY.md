...
TradeMind là hệ thống **research + proposal + human-approved paper execution**. Nó không kết nối broker và không thể tạo live order. Forecast, sentiment, RAG answer, backtest và decision đều có thể sai; người dùng phải tự thẩm định trước mọi quyết định tài chính.
